  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log(transactionData); // Tambahkan ini untuk memeriksa respons dari server
  ...
  return (
    <div className="flex justify-around mb-10 space-x-4">
      ...
      <div className="bg-red-50 p-5 rounded-md border border-red-200 w-1/2 mt-4">
        ...
        <h1 className="text-2xl font-bold text-red-900 pt-3">Rp. {transactionMetrics.totalRevenue}</h1>
      </div>
    </div>
  );
};
